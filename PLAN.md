...
| 3a    | 6        | Cancel refund + dispute resolve        | **Next**     |
...
| 5     | UI split              | **Done**                       |
| 6     | Refund & dispute      | **Next** ← pick up here        |
...
| **6**    | Refund & dispute | Bad proof → `DISPUTED` → resolve refund to customer (on-chain)                                           | **Next** |
...
**Next code commit:** Phase 6 — `Add on-chain refund helper for order escrow.`